...
import { privacyDocument, termsDocument } from '@/content/legal'
...
const document = computed(() =>
  props.documentType === 'privacy' ? privacyDocument : termsDocument,
)
...
usePageMeta({
  ...
  path: computed(
    () => `/${props.slug}/${props.documentType === 'privacy' ? 'policy' : 'terms-and-conditions'}`,
  ),

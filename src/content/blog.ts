      ...
      },
      {
        ...
        paragraphs: [
          copy(
            ...
            'Juntos, estos dos proyectos representan los dos pilares de un negocio de apps indie sostenible: mecánicas de monetización dentro de la app y herramientas de adquisición de usuarios fuera de ella. [rewarded_ad_counter](https://pub.dev/packages/rewarded_ad_counter) convierte usuarios gratuitos en ingresos sin degradar su experiencia. [companies-scraper](https://github.com/erperejildo/companies-scraper) encuentra los usuarios correctos y pone tu app frente a ellos. Ambos son gratuitos, ambos son open-source y ambos están probados en batalla en nuestro portfolio de doce apps. Creemos en crear herramientas que nos ayuden primero a nosotros y después a la comunidad — y publicarlas para que todos se beneficien.',
          ),
        ],
      },
    ],

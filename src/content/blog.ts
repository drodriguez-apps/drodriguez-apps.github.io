    ...
    content: [
      {
        ...
        paragraphs: [
          ...
          copy(
            'Today, every app in our catalog — DriveCam, My Rents, AI Sabotage, HomeHandy, Tandapp, The Impostor, Party Words, MyHoldings, TimeTap, Mind your Math, Horas Extras, and Lucra — ships from one repo per product. That is twelve apps live on Google Play, all available on the App Store, and several also running natively on macOS. One team, one language, twelve products.',
            'Hoy, cada app de nuestro catálogo — DriveCam, My Rents, AI Sabotage, HomeHandy, Tandapp, The Impostor, Party Words, MyHoldings, TimeTap, Mind your Math, Horas Extras y Lucra — se publica desde un solo repositorio por producto. Son doce apps publicadas en Google Play, todas disponibles en la App Store, y varias también funcionando de forma nativa en macOS. Un equipo, un lenguaje, doce productos.',
          ),
        ],
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: [
          copy(
            'Having five dedicated app websites plus this central studio site creates a web of interlinked properties. Each site links back to Axis Labs, and each studio page links to the individual app sites. This cross-linking builds topical authority in search engines, strengthens domain trust signals, and gives users multiple pathways to discover our products. A user who finds drivecam.store through a search query may then explore axislabs.eu and discover My Rents or HomeHandy — apps they did not know they needed.',
            'Tener cinco webs de apps dedicadas más este sitio central del estudio crea una red de propiedades interenlazadas. Cada sitio enlaza de vuelta a Axis Labs, y cada página del estudio enlaza a los sitios individuales de las apps. Este enlazado cruzado construye autoridad temática en los motores de búsqueda, refuerza señales de confianza del dominio y da a los usuarios múltiples caminos para descubrir nuestros productos. Un usuario que encuentra drivecam.store a través de una búsqueda puede luego explorar axislabs.eu y descubrir My Rents o HomeHandy — apps que no sabía que necesitaba.',
          ),
        ],
      },
    ],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          copy(
            ...
            'companies-scraper es una herramienta CLI en Python que descubre sitios web de negocios locales por idioma y región geográfica, extrae direcciones de correo corporativo verificadas y genera listas de contactos deduplicadas. Soporta ocho idiomas, aprovecha datos geográficos offline hasta nivel de ciudad para segmentación precisa, y usa búsqueda de DuckDuckGo en lugar de costosas APIs de Google. Puede decodificar correos ofuscados por Cloudflare, filtrar direcciones de correo gratuitas, y persistir resultados de forma incremental para que trabajos largos nunca pierdan progreso.',
          ),
          copy(
            'We use it actively to drive targeted outreach campaigns for My Rents (contacting real estate agencies) and DriveCam (reaching driving schools across Europe). The tool replaces paid services like Apollo or Hunter.io, saving hundreds of dollars monthly while delivering higher-quality, geo-targeted leads. The full source code is available on GitHub for other developers who need a free, privacy-respecting lead generation engine.',
            'Lo usamos activamente para impulsar campañas de contacto dirigido para My Rents (contactando inmobiliarias) y DriveCam (llegando a autoescuelas en toda Europa). La herramienta reemplaza servicios de pago como Apollo o Hunter.io, ahorrando cientos de euros al mes mientras entrega leads de mayor calidad y geo-segmentados. El código fuente completo está disponible en GitHub para otros desarrolladores que necesiten un motor de generación de leads gratuito y respetuoso con la privacidad.',
          ),
        ],
      },
      {
        ...
        paragraphs: [
          copy(
            ...
            'Juntos, estos dos proyectos representan los dos pilares de un negocio de apps indie sostenible: mecánicas de monetización dentro de la app y herramientas de adquisición de usuarios fuera de ella. rewarded_ad_counter convierte usuarios gratuitos en ingresos sin degradar su experiencia. companies-scraper encuentra los usuarios correctos y pone tu app frente a ellos. Ambos son gratuitos, ambos son open-source y ambos están probados en batalla en nuestro portfolio de doce apps. Creemos en crear herramientas que nos ayuden primero a nosotros y después a la comunidad — y publicarlas para que todos se beneficien.',
          ),
        ],
      },
    ],

...
const eyebrow = copy('How it works', 'Como funciona')
const lead = copy(
...
const steps = [
  {
    ...
    description: copy(
      ...
      'Define el angulo del producto, la narrativa visual y para quien es la app antes de construir la pagina.',
    ),
  },
  {
    number: '02',
    ...
    description: copy(
      ...
      'Anade instalaciones, resumenes, visuales y rutas listas para store para que el lanzamiento se sienta completo.',
    ),
  },
  {
    number: '03',
    ...
    description: copy(
      ...
      'Publica una pagina estatica rapida que se puede compartir, indexar y ampliar sin rehacer el sistema.',
    ),
  },
]
